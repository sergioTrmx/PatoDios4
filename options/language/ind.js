exports.noregis = () => {
        return `*AMIGO TODAVÍA NO ESTÁ REGISTRADO* \n\n *Cómo registrarse ${prefix} registrar Nombre|edad* \n *Ejemplo: ${prefix} registrar Sergio|40*`
}

exports.rediregis = () => {
        return `*「 REGISTRADO 」*\n\n*Listo ya quedaste registrado pana:)*`
}

exports.wrongf = () => {
        return`*Algo hiciste mal, ve el ejemplo y hazlo bien*`
}
